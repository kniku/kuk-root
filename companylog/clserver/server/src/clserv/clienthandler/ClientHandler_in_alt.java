...
public class ClientHandler_in_alt extends AClientHandler_es_logger {
	...
	public void handle(String iCommand) throws IOException {
		...
		iCommand = "<" + clserv.shared.Constants.RequestTypeElements.IN + " " + clserv.shared.Constants.RequestValueAttrs.Login + "=\""+iCommand.substring(10,13)+"\""+(info == null ? "" : info) + " />";
