...
#ifndef _PDBD_SQLITE3_H
#define _PDBD_SQLITE3_H

namespace klib {
namespace dbi {

class DbdDyn_C_Environment_sqlite3 : public DbdDyn_C_Environment {
public:
	DbdDyn_C_Environment_sqlite3(const klib::base::CLogger *iLogger) : DbdDyn_C_Environment(iLogger) {}
...
class DbdDyn_C_Connection_sqlite3 : public DbdDyn_C_Connection {
public:
	DbdDyn_C_Connection_sqlite3(DbdDyn_C_Environment *iEnv, const char *iHost, const char *iUser, const char *iPasswd, const char *iDatabase) : DbdDyn_C_Connection(iEnv, iHost, iUser, iPasswd, iDatabase) { }
	// interface implementation
	void					i_connect(void);
...
class DbdDyn_C_Statement_sqlite3 : public DbdDyn_C_Statement {
private:
	long m_fetch_cnt;
public:
	DbdDyn_C_Statement_sqlite3(DbdDyn_C_Connection *iInterface);
...
class DbdDyn_C_Result_sqlite3 : public DbdDyn_C_Result {
public:
	DbdDyn_C_Result_sqlite3(DbdDyn_C_Statement *iStmt) : DbdDyn_C_Result (iStmt) {}
	~DbdDyn_C_Result_sqlite3() {};
	bool DbdDyn_C_Result_sqlite3::get_result(DataType iType, unsigned int idx, void *pData) const;
	// interface implementation
	bool							i_Next(void);
