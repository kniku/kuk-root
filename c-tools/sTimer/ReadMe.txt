================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : sTimer Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese sTimer-Anwendung erstellt. 
...
res\sTimer.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei sTimer.rc eingebunden.
...
sTimerDlg.h, sTimerDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CsTimerDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in sTimer.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    sTimer.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
