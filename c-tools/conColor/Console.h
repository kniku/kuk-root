...
namespace JadedHoboConsole
{
    ...
    static class con_dev
    {
        ...
        CONSOLE_SCREEN_BUFFER_INFO  csbi_original; 
        DWORD                       dwConSize;
        ...
        { 
            ...
            GetConsoleScreenBufferInfo( hCon, &csbi_original );
        }
        private:
        void GetInfo()
        {
		...
		{
            SetConsoleTextAttribute( hCon, csbi_original.wAttributes );
		}
		WORD GetBgColor_original() {
			return csbi_original.wAttributes & bgMask;
		}
		WORD GetFgColor_original() {
			return csbi_original.wAttributes & fgMask;
		}
    } console;
    ...
    inline std::ostream& fg_darkred( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& fg_darkgreen( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& fg_darkblue( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& fg_darkwhite( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& fg_darkcyan( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& fg_darkmagenta( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& fg_darkyellow( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkred( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkgreen( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkblue( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkwhite( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkcyan( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkmagenta( std::ostream& os )
    {
        os.flush();
    ...
    inline std::ostream& bg_darkyellow( std::ostream& os )
    {
        os.flush();
